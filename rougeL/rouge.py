...
import six
import rougeL.rouge_score as rouge_score
import io
import os
...
# Added 'beta' to rouge implementation
class Rouge:
    ...
    def __init__(self, metrics=None, stats=None, return_lengths=False,
                 raw_results=False, exclusive=True,beta=1.0):
        self.return_lengths = return_lengths
        self.raw_results = raw_results
        self.exclusive = exclusive
        self.beta=beta # modified
